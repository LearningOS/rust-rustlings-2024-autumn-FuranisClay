...
fn build_scores_table(results: String) -> HashMap<String, Team> {
    ...
    for r in results.lines() {
        ...
        // score.insert(team_1_name, Team { goals_scored: team_1_score, goals_conceded: team_2_score });
        // score.insert(team_2_name, Team { goals_scored: team_2_score, goals_conceded: team_1_score });
